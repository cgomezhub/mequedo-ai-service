...
from .views import (
    ...
    SendReservationRequestApprovedView,
...
urlpatterns = [
    ...
    path('send-reservation-request-approved/', SendReservationRequestApprovedView.as_view(),
             name='send-reservation-request-approved'),

...
class PlatformActionTool(BaseTool):
    ...
    description: str = (
        ...
        "Valid actions: 'START_REGISTRATION', 'START_ID_VERIFICATION', 'START_RENT_PROCESS'. "
    ...
    def _run(self, session_id: str, action_name: str) -> str:
        ...
        try:
            ...
            if not clean_action:
                return f"Error: '{action_name}' is not a valid action. Use START_REGISTRATION, START_ID_VERIFICATION, or START_RENT_PROCESS."
            ...
            if result.modified_count > 0 or result.matched_count > 0:
                logger.info(f"UI Action '{clean_action}' triggered for session {session_id}")
